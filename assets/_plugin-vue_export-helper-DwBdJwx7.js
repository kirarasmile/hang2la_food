...
`,[f("input, textarea",`
 ...
 `),F("&:-webkit-autofill ~",[f("placeholder","display: none;")])]),$("round",[X("textarea","border-radius: calc(var(--n-height) / 2);")]),f("placeholder",`
 pointer-events: none;
 position: absolute;
 left: 0;
 right: 0;
 ...
 `)]),F("&:hover",[f("state-border","border: var(--n-border-hover);")]),$("focus","background-color: var(--n-color-focus);",[f("state-border",`
