import{g as T,k as y,m as $,x as re,$ as K,h as l,a0 as fe,e as i,a1 as G,a as x,a2 as Ve,a3 as z,f as D,a4 as qe,a5 as Ke,a6 as $e,y as Ge,a7 as me,a8 as se,r as Ze,a9 as Je,u as ne,n as q,aa as Qe,t as et,ab as ie,p as tt,q as le,s as rt,ac as nt,z as _e,ad as at,Z as oe,ae as ot,af as Se,_ as he,l as ze,w as st,v as it,ag as lt,ah as dt,ai as de,aj as Q,ak as ct,al as ut,am as ft,an as mt,ao as ht,ap as bt,aq as vt,ar as pt,as as gt,at as wt,au as U,av as yt,aw as xt,C as ae,D as P,G as d,ax as Ct,ay as Y,J as L,az as Z,K as f,L as R,M as w,F as Re,Q as Be,P as $t,I as te,O as ee,N as _t,T as J}from"./index-ChtlSxlN.js";import{g as St,b as ce,C as zt,T as Rt,a as Bt}from"./index-BI6IjMO1.js";import{a as be,f as ve,N as ke,_ as ue,b as kt}from"./_plugin-vue_export-helper-Xb4DSPjn.js";import{N as Tt,a as Nt}from"./Checkbox-C6Arrw5G.js";import{N as Et,a as Ot}from"./RadioGroup--c0U83Rc.js";const pe=T({name:"SlotMachineNumber",props:{clsPrefix:{type:String,required:!0},value:{type:[Number,String],required:!0},oldOriginalNumber:{type:Number,default:void 0},newOriginalNumber:{type:Number,default:void 0}},setup(e){const r=y(null),t=y(e.value),s=y(e.value),o=y("up"),n=y(!1),a=$(()=>n.value?`${e.clsPrefix}-base-slot-machine-current-number--${o.value}-scroll`:null),m=$(()=>n.value?`${e.clsPrefix}-base-slot-machine-old-number--${o.value}-scroll`:null);re(K(e,"value"),(h,c)=>{t.value=c,s.value=h,fe(v)});function v(){const h=e.newOriginalNumber,c=e.oldOriginalNumber;c===void 0||h===void 0||(h>c?_("up"):c>h&&_("down"))}function _(h){o.value=h,n.value=!1,fe(()=>{var c;(c=r.value)===null||c===void 0||c.offsetWidth,n.value=!0})}return()=>{const{clsPrefix:h}=e;return l("span",{ref:r,class:`${h}-base-slot-machine-number`},t.value!==null?l("span",{class:[`${h}-base-slot-machine-old-number ${h}-base-slot-machine-old-number--top`,m.value]},t.value):null,l("span",{class:[`${h}-base-slot-machine-current-number`,a.value]},l("span",{ref:"numberWrapper",class:[`${h}-base-slot-machine-current-number__inner`,typeof e.value!="number"&&`${h}-base-slot-machine-current-number__inner--not-number`]},s.value)),t.value!==null?l("span",{class:[`${h}-base-slot-machine-old-number ${h}-base-slot-machine-old-number--bottom`,m.value]},t.value):null)}}}),{cubicBezierEaseOut:V}=G;function Ft({duration:e=".2s"}={}){return[i("&.fade-up-width-expand-transition-leave-active",{transition:`
 opacity ${e} ${V},
 max-width ${e} ${V},
 transform ${e} ${V}
