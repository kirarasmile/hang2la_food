import{g as T,k as y,m as $,x as re,W as K,h as l,X as fe,e as i,Y as G,a as x,Z as Ve,_ as z,f as D,$ as qe,a0 as Ke,a1 as $e,y as Ge,a2 as me,a3 as se,r as Ze,a4 as Je,u as ne,n as q,a5 as Qe,t as et,a6 as ie,p as tt,q as le,s as rt,a7 as nt,z as _e,a8 as at,a9 as oe,aa as ot,ab as Se,ac as he,l as ze,w as st,v as it,ad as lt,ae as dt,af as de,ag as Q,ah as ct,ai as ut,aj as ft,ak as mt,al as ht,am as bt,an as vt,ao as pt,ap as gt,aq as wt,ar as U,as as yt,at as xt,C as ae,D as P,G as d,au as Ct,av as L,M as Y,aw as Z,N as f,K as R,J as w,F as Re,L as Be,ax as $t,I as te,Q as ee,ay as _t,S as J}from"./index-Cm_SX6ap.js";import{g as St,b as ce,C as zt,T as Rt,a as Bt}from"./index-TCizGd1Y.js";import{a as be,f as ve,N as ke,_ as ue,b as kt}from"./_plugin-vue_export-helper-BVV14t8g.js";import{N as Tt,a as Nt}from"./Checkbox-8RZ3_wqu.js";import{N as Et,a as Ot}from"./RadioGroup-BOx8ROlR.js";const pe=T({name:"SlotMachineNumber",props:{clsPrefix:{type:String,required:!0},value:{type:[Number,String],required:!0},oldOriginalNumber:{type:Number,default:void 0},newOriginalNumber:{type:Number,default:void 0}},setup(e){const r=y(null),t=y(e.value),s=y(e.value),o=y("up"),n=y(!1),a=$(()=>n.value?`${e.clsPrefix}-base-slot-machine-current-number--${o.value}-scroll`:null),m=$(()=>n.value?`${e.clsPrefix}-base-slot-machine-old-number--${o.value}-scroll`:null);re(K(e,"value"),(h,c)=>{t.value=c,s.value=h,fe(v)});function v(){const h=e.newOriginalNumber,c=e.oldOriginalNumber;c===void 0||h===void 0||(h>c?_("up"):c>h&&_("down"))}function _(h){o.value=h,n.value=!1,fe(()=>{var c;(c=r.value)===null||c===void 0||c.offsetWidth,n.value=!0})}return()=>{const{clsPrefix:h}=e;return l("span",{ref:r,class:`${h}-base-slot-machine-number`},t.value!==null?l("span",{class:[`${h}-base-slot-machine-old-number ${h}-base-slot-machine-old-number--top`,m.value]},t.value):null,l("span",{class:[`${h}-base-slot-machine-current-number`,a.value]},l("span",{ref:"numberWrapper",class:[`${h}-base-slot-machine-current-number__inner`,typeof e.value!="number"&&`${h}-base-slot-machine-current-number__inner--not-number`]},s.value)),t.value!==null?l("span",{class:[`${h}-base-slot-machine-old-number ${h}-base-slot-machine-old-number--bottom`,m.value]},t.value):null)}}}),{cubicBezierEaseOut:V}=G;function Ft({duration:e=".2s"}={}){return[i("&.fade-up-width-expand-transition-leave-active",{transition:`
 opacity ${e} ${V},
 max-width ${e} ${V},
 transform ${e} ${V}
