...
`,[f("input, textarea",`
 ...
 `),T("&:-webkit-autofill ~",[f("placeholder","display: none;")])]),E("round",[X("textarea","border-radius: calc(var(--n-height) / 2);")]),f("placeholder",`
 pointer-events: none;
 position: absolute;
 left: 0;
 right: 0;
 ...
 `)]),E("textarea",[f("placeholder","overflow: visible;")]),X("autosize","width: 100%;"),E("autosize",[f("textarea-el, input-el",`
 position: absolute;
 top: 0;
 left: 0;
 height: 100%;
 ...
 `)]),T("&:hover",[f("state-border","border: var(--n-border-hover);")]),E("focus","background-color: var(--n-color-focus);",[f("state-border",`
 ...
 `),["warning","error"].map(e=>E(`${e}-status`,[X("disabled",[P("base-loading",`
