import{f as T,r as y,j as $,p as re,O as K,h as l,P as fe,d as i,Q as G,a as x,R as z,e as H,T as Ve,q as qe,S as se,u as ne,k as q,o as Ke,m as Ge,s as $e,U as Ze,V as ae,W as me,g as Se,w as Qe,n as Je,X as J,Y as et,Z as tt,t as oe,v as P,y as d,_ as rt,$ as L,B as Y,a0 as Z,C as f,D as R,E as w,F as _e,I as ze,H as nt,A as te,G as ee}from"./index-DwCDJex0.js";import{f as he,g as ot,F as at,c as st,d as ie,b as it,p as lt,m as dt,z as ct,L as ut,e as ft,h as le,C as mt,T as ht,a as bt}from"./index-BDm9Nfxt.js";import{f as vt,g as pt,h as Re,r as gt,j as wt,k as yt,l as de,u as ce,c as xt,S as Be,m as Ct,n as $t,o as be,q as ve,s as U,t as St,d as ke,_ as ue,v as _t,N as zt,B as Q}from"./_plugin-vue_export-helper-Bw40c_nT.js";import{N as Rt,a as Bt}from"./Checkbox-CjNUI0-_.js";import{u as kt,a as Tt,N as Et,b as Nt}from"./RadioGroup-BMHkboq6.js";import{f as Ot}from"./fade-in-height-expand.cssr-BWyNFz38.js";const pe=T({name:"SlotMachineNumber",props:{clsPrefix:{type:String,required:!0},value:{type:[Number,String],required:!0},oldOriginalNumber:{type:Number,default:void 0},newOriginalNumber:{type:Number,default:void 0}},setup(e){const r=y(null),t=y(e.value),s=y(e.value),a=y("up"),n=y(!1),o=$(()=>n.value?`${e.clsPrefix}-base-slot-machine-current-number--${a.value}-scroll`:null),m=$(()=>n.value?`${e.clsPrefix}-base-slot-machine-old-number--${a.value}-scroll`:null);re(K(e,"value"),(h,c)=>{t.value=c,s.value=h,fe(v)});function v(){const h=e.newOriginalNumber,c=e.oldOriginalNumber;c===void 0||h===void 0||(h>c?S("up"):c>h&&S("down"))}function S(h){a.value=h,n.value=!1,fe(()=>{var c;(c=r.value)===null||c===void 0||c.offsetWidth,n.value=!0})}return()=>{const{clsPrefix:h}=e;return l("span",{ref:r,class:`${h}-base-slot-machine-number`},t.value!==null?l("span",{class:[`${h}-base-slot-machine-old-number ${h}-base-slot-machine-old-number--top`,m.value]},t.value):null,l("span",{class:[`${h}-base-slot-machine-current-number`,o.value]},l("span",{ref:"numberWrapper",class:[`${h}-base-slot-machine-current-number__inner`,typeof e.value!="number"&&`${h}-base-slot-machine-current-number__inner--not-number`]},s.value)),t.value!==null?l("span",{class:[`${h}-base-slot-machine-old-number ${h}-base-slot-machine-old-number--bottom`,m.value]},t.value):null)}}}),{cubicBezierEaseOut:V}=G;function Ft({duration:e=".2s"}={}){return[i("&.fade-up-width-expand-transition-leave-active",{transition:`
 opacity ${e} ${V},
 max-width ${e} ${V},
 transform ${e} ${V}
