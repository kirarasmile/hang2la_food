import{g as T,k as y,m as $,x as re,Z as K,h as l,_ as fe,e as i,$ as G,a as x,a0 as Ve,a1 as z,f as D,a2 as qe,a3 as Ke,a4 as $e,y as Ge,a5 as me,a6 as se,r as Ze,a7 as Je,u as ne,n as q,a8 as Qe,t as et,a9 as ie,p as tt,q as le,s as rt,aa as nt,z as _e,ab as at,ac as oe,ad as ot,S as Se,ae as he,l as ze,w as st,v as it,af as lt,ag as dt,ah as de,ai as Q,aj as ct,ak as ut,al as ft,am as mt,an as ht,ao as bt,ap as vt,aq as pt,ar as gt,as as wt,at as W,au as yt,av as xt,C as ae,D as P,G as d,aw as Ct,ax as Y,J as L,ay as Z,K as f,L as R,M as w,F as Re,Q as Be,P as $t,I as te,O as ee,N as _t,U as J}from"./index-C84fRpCZ.js";import{g as St,b as ce,C as zt,T as Rt,a as Bt}from"./index-42J8-QdI.js";import{a as be,f as ve,N as ke,_ as ue,b as kt}from"./_plugin-vue_export-helper-DI8fTAil.js";import{N as Tt,a as Nt}from"./Checkbox-Cj2ZBpPL.js";import{N as Et,a as Ot}from"./RadioGroup-BBq94_mX.js";const pe=T({name:"SlotMachineNumber",props:{clsPrefix:{type:String,required:!0},value:{type:[Number,String],required:!0},oldOriginalNumber:{type:Number,default:void 0},newOriginalNumber:{type:Number,default:void 0}},setup(e){const r=y(null),t=y(e.value),s=y(e.value),o=y("up"),n=y(!1),a=$(()=>n.value?`${e.clsPrefix}-base-slot-machine-current-number--${o.value}-scroll`:null),m=$(()=>n.value?`${e.clsPrefix}-base-slot-machine-old-number--${o.value}-scroll`:null);re(K(e,"value"),(h,c)=>{t.value=c,s.value=h,fe(v)});function v(){const h=e.newOriginalNumber,c=e.oldOriginalNumber;c===void 0||h===void 0||(h>c?_("up"):c>h&&_("down"))}function _(h){o.value=h,n.value=!1,fe(()=>{var c;(c=r.value)===null||c===void 0||c.offsetWidth,n.value=!0})}return()=>{const{clsPrefix:h}=e;return l("span",{ref:r,class:`${h}-base-slot-machine-number`},t.value!==null?l("span",{class:[`${h}-base-slot-machine-old-number ${h}-base-slot-machine-old-number--top`,m.value]},t.value):null,l("span",{class:[`${h}-base-slot-machine-current-number`,a.value]},l("span",{ref:"numberWrapper",class:[`${h}-base-slot-machine-current-number__inner`,typeof e.value!="number"&&`${h}-base-slot-machine-current-number__inner--not-number`]},s.value)),t.value!==null?l("span",{class:[`${h}-base-slot-machine-old-number ${h}-base-slot-machine-old-number--bottom`,m.value]},t.value):null)}}}),{cubicBezierEaseOut:V}=G;function Ft({duration:e=".2s"}={}){return[i("&.fade-up-width-expand-transition-leave-active",{transition:`
 opacity ${e} ${V},
 max-width ${e} ${V},
 transform ${e} ${V}
